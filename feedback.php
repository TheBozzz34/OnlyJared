...
$mailto = 'lskywalker416@gmail.com' ;
$subject = "Feedback Form" ;
$formurl = "https://wrathoftheteletubbies.live/feedback.html" ;
$thankyouurl = "https://wrathoftheteletubbies.live" ;
$errorurl = "https://wrathoftheteletubbies.live" ;
$want_tel_field = 0;
$want_addr_field = 0;
...
$my_captcha_secret_key = '0x397941cBeEcF702aB9556933e6a7589eFfaD3c4B' ;

// -------------------- END OF CONFIGURABLE SECTION ---------------

define( 'MAX_LINE_LENGTH', 998 );
define( 'CONTENT_TYPE', 'Content-Type: text/plain; charset="utf-8"' );
define( 'CAPTCHA_API_URL', 'https://hcaptcha.com/siteverify' );
define( 'CAPTCHA_RESPONSE_PARAM', 'h-captcha-response' );
$linesep = $uself ? "\n" : "\r\n" ;
if ($use_sendmailfrom) {
...
if (strlen( $my_captcha_secret_key )) {
	$captcha_post_params = http_build_query( array(
								'secret' => $my_captcha_secret_key,
								'response' => $_POST[ CAPTCHA_RESPONSE_PARAM ],
								'remoteip' => $_SERVER['REMOTE_ADDR']
								) );
	$captcha_context = stream_context_create(
							array ( 'http' => array(
								'method' => 'POST',
								'header' => 'Content-type: application/x-www-form-urlencoded',
								'content' => $captcha_post_params
								)
							)
						);
	$captcha_reply = file_get_contents( CAPTCHA_API_URL, FALSE, $captcha_context );
	$captcha_decoded = ($captcha_reply !== FALSE) ? json_decode ( $captcha_reply, TRUE ) : NULL ;
	if ($captcha_reply === FALSE || $captcha_decoded == NULL || (trim($captcha_decoded['success']) != TRUE)) {
		header( "Location: $errorurl" );
		exit ;
	}
}
